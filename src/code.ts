...
*/
function getOverridesForNode(source:SceneNode, target:SceneNode, recursionLevel:number) {
...
// recursion
function compareOverrides(source:IOverrideData, target:IOverrideData, recursionLevel:number) {
...
function applyOverrideProp(key:string, prop:any, target:SceneNode, isRoot: boolean) {
    // console.log("fop", key, prop);
    switch (key) {
        case "backgrounds":
        case "fills":
...
function applyOverridesToNode(overrides:IOverrideData, target:any, recursionLevel:number) {
