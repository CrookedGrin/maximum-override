    ...
    */
    ...
    if (hasNewMaster) {
        ...
        try {
            ...
            _util__WEBPACK_IMPORTED_MODULE_0__["log"](recursionLevel, 'New Master', newSourceNode.name, newSourceData);
            sourceData = newSourceData;
            temporaryNodes.push(newSourceNode);
        }
        catch (e) {
            _util__WEBPACK_IMPORTED_MODULE_0__["log"](recursionLevel + 1, "Couldn't create an instance. Is this a nested master component?", e);
            return;
        }
    }
...
function getSourceAndTargetFromSelection(selection) {
    ...
    if (selection.length === 1) {
        ...
        if (targetNode.type === "INSTANCE") {
            ...
            _util__WEBPACK_IMPORTED_MODULE_0__["log"](0, "Comparing master ", sourceData, " to target ", targetData);
...
/*!*********************!*\
  !*** ./src/util.ts ***!
  \*********************/
/*! exports provided: log, createDataWrapperForNode, supportsChildren, supportsAutoLayout, checkEquality, formatOverrideProp, countChildren, getPropsFromNode, SelectionValidation, validateSelection, RGBToHex */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
